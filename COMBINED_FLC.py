...
class MyNode(Node):
	...
	def timer_callback(self):
		self.PID()
		self.membership(min(min(self.laser_ranges[0:50]),min(self.laser_ranges[1390:1440])), min(self.laser_ranges[50:150]), min(self.laser_ranges[1290:1390]), min(self.laser_ranges[1050:1300]), min(self.laser_ranges[850:1050]))
	...
	def membership(self, distance1, distance2, distance3, distance4, distance5):

		if min(distance1, distance2, distance3) > min(distance4, distance5):
			membership_right(distance4, distance5)
		else:
			membership_obstacle(distance1, distance2, distance3)



	def membership_right(self, distance1, distance2):

		self.distance = {}
		self.distance["Near"] = [0.00, 0.00, 0.2, 0.4]
		self.distance["Medium"] = [0.2, 0.4, 0.6]
		self.distance["Far"] = [0.4, 0.6, 10.0, 10.0]
		self.speed = {}
		self.speed["Slow"] = 0.8
		...
		r = {"Near": 100.0, "Medium": 100.0, "Far": 100.0}
		f = {"Near": 100.0, "Medium": 100.0, "Far": 100.0}
		valDistance1 = ""
		valDistance2 = ""
		d1 = list(self.distance.values())[0]
		d2 = list(self.distance.values())[1]
		d3 = list(self.distance.values())[2]
		if (distance1 >= list(self.distance.values())[0][1] and distance1 <=list(self.distance.values())[0][2]):
			f["Near"] = 1.0
			valDistance1 = "Near"
		elif (distance1 >= list(self.distance.values())[2][1] and distance1 <=list(self.distance.values())[2][2]):
			f["Far"] = 1.0
			valDistance1 = "Far"
		elif distance1 == list(self.distance.values())[1][1]:
			f["Medium"] = 1.0
			valDistance1 = "Medium"
		elif distance1 > list(self.distance.values())[0][2] and distance1 < list(self.distance.values())[0][3]:
			f["Near"] = (d1[3] - distance1) / (d1[3] - d1[2])
			r["Medium"] = (distance1 - d2[0]) / (d2[1] - d2[0])
			valDistance1 = "Near"
			valDistance2 = "Medium"
		elif distance1 > list(self.distance.values())[1][1] and distance1 < list(self.distance.values())[1][2]:
			f["Medium"] = (d2[2] - distance1) / (d2[2] - d2[1])
			r["Far"] = (distance1 - d3[0]) / (d3[1] - d3[0])
			valDistance1 = "Medium"
			valDistance2 = "Far"
		...
		s1Val = []
		for i in range(9):
			if (valDistance1 == "Near" or valDistance2 == "Near") and (valDistance3 == "Near" or valDistance4 == "Near") and i == 0:
				if f1["Near"] != 100.0:
					x1.append(f1["Near"])
				else:
					x1.append(r1["Near"])
				...
				s0Val.append("Slow")
				s1Val.append("Left")
			elif (valDistance1 == "Near" or valDistance2 == "Near") and (valDistance3 == "Medium" or valDistance4 == "Medium") and i == 1:
				if f1["Near"] != 100.0:
					x1.append(f1["Near"])
				else:
					x1.append(r1["Near"])
				...
				s0Val.append("Slow")
				s1Val.append("Left")
			elif (valDistance1 == "Near" or valDistance2 == "Near") and (valDistance3 == "Far" or valDistance4 == "Far") and i == 2:
				if f1["Near"] != 100.0:
					x1.append(f1["Near"])
				else:
					x1.append(r1["Near"])
				...
				s0Val.append("Medium")
				s1Val.append("Left")
			elif (valDistance1 == "Medium" or valDistance2 == "Medium") and (valDistance3 == "Near" or valDistance4 == "Near") and i == 3:
				if f1["Medium"] != 100.0:
					x1.append(f1["Medium"])
				else:
					x1.append(r1["Medium"])
				...
				s0Val.append("Medium")
				s1Val.append("Right")
			elif (valDistance1 == "Medium" or valDistance2 == "Medium") and (valDistance3 == "Medium" or valDistance4 == "Medium") and i == 4:
				if f1["Medium"] != 100.0:
					x1.append(f1["Medium"])
				else:
					x1.append(r1["Medium"])
				...
				s0Val.append("Slow")
				s1Val.append("Zero")
			elif (valDistance1 == "Medium" or valDistance2 == "Medium") and (valDistance3 == "Far" or valDistance4 == "Far") and i == 5:
				if f1["Medium"] != 100.0:
					x1.append(f1["Medium"])
				else:
					x1.append(r1["Medium"])
				...
				s0Val.append("Medium")
				s1Val.append("Left")
			elif (valDistance1 == "Far" or valDistance2 == "Far") and (valDistance3 == "Near" or valDistance4 == "Near") and i == 6:
				if f1["Far"] != 100.0:
					x1.append(f1["Far"])
				else:
					x1.append(r1["Far"])
				...
				s0Val.append("Slow")
				s1Val.append("Right")
			elif (valDistance1 == "Far" or valDistance2 == "Far") and (valDistance3 == "Medium" or valDistance4 == "Medium") and i == 7:
				if f1["Far"] != 100.0:
					x1.append(f1["Far"])
				else:
					x1.append(r1["Far"])
				...
				s0Val.append("Medium")
				s1Val.append("Right")
			elif (valDistance1 == "Far" or valDistance2 == "Far") and (valDistance3 == "Far" or valDistance4 == "Far") and i == 8:
				if f1["Far"] != 100.0:
					x1.append(f1["Far"])
				else:
					x1.append(r1["Far"])
		...
		for i in range(len(x1)):
			self.s01 = self.s01 + (min(x1[i], x2[i]) * self.speed[s0Val[i]])
			self.s02 = self.s02 + min(x1[i], x2[i])
			self.s11 = self.s11 + (min(x1[i], x2[i]) * self.steering[s1Val[i]])
			self.s12 = self.s12 + min(x1[i], x2[i])
			self.speedFinal = self.s01 / self.s02
			self.steeringFinal = self.s11 / self.s12

	def membership_obstacle(self, distance1, distance2, distance3):
